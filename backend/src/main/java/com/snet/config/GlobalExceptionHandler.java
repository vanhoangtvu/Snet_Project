...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDataAccess(DataAccessException ex) {
        ...
        System.err.println("DataAccessException: " + msg);
        
        return build(HttpStatus.INTERNAL_SERVER_ERROR, "Lỗi cơ sở dữ liệu: " + (msg != null ? msg.substring(0, Math.min(100, msg.length())) : "Unknown"));
    }
